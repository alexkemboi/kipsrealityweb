  ...
  height={350}
        ...
        <div className="relative z-10 text-center px-6">
          <h1 className="text-4xl lg:text-6xl font-bold text-white mb-4 tracking-tight">
            Discover <span className="text-[#00b7ff]">Who We Are</span>
          </h1>
          <p className="text-white/80 max-w-2xl mx-auto text-lg">
            Empowering real estate experiences with innovation, trust, and a passion for seamless property management.
          </p>
        </div>
      </section>
