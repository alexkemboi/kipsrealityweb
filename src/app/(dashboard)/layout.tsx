...
/**
 * Role access config (kept in-file for single-file paste convenience)
 * You can extract later to src/lib/routing/roleAccess.ts
 */
...
/**
 * If "/" should always redirect to role home, remove "/" from this list.
 */
...
/**
 * Returns null if current path is allowed or should be skipped.
 * Returns role home path if redirect is required.
 */
...
/**
 * Hydration-safe shell (better UX than returning null)
 */
...
function DashboardLayoutContent({ children }: DashboardLayoutProps) {
  ...
  // Reset redirect guard once pathname changes
  useEffect(() => {
