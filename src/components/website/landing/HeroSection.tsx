    ...
    <>
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .hero-animate-spin-slow {
          animation: hero-spin-slow 3s linear infinite;
        }
        .hero-animate-bounce-subtle {
          animation: hero-bounce-subtle 2s ease-in-out infinite;
        }
      `}} />
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          {/* Floating Particles */}
          <div className="absolute top-[20%] left-[10%] w-2 h-2 bg-teal-400 rounded-full hero-animate-float opacity-60"></div>
          <div className="absolute top-[60%] left-[15%] w-1 h-1 bg-blue-400 rounded-full hero-animate-float opacity-40" style={{ animationDelay: '1s', animationDuration: '4s' }}></div>
          <div className="absolute top-[40%] right-[20%] w-1.5 h-1.5 bg-purple-400 rounded-full hero-animate-float opacity-50" style={{ animationDelay: '2s', animationDuration: '5s' }}></div>
          <div className="absolute top-[80%] right-[10%] w-2 h-2 bg-teal-300 rounded-full hero-animate-float opacity-60" style={{ animationDelay: '0.5s', animationDuration: '3.5s' }}></div>
          <div className="absolute top-[15%] right-[30%] w-1 h-1 bg-blue-300 rounded-full hero-animate-float opacity-40" style={{ animationDelay: '1.5s', animationDuration: '4.5s' }}></div>
          
          {/* Large Gradient Orbs */}
          <div className="absolute top-1/4 -left-32 w-96 h-96 bg-gradient-to-br from-teal-500/20 to-blue-500/20 rounded-full blur-3xl hero-animate-pulse-slow"></div>
          <div className="absolute bottom-1/4 -right-32 w-[500px] h-[500px] bg-gradient-to-bl from-purple-500/20 to-teal-500/20 rounded-full blur-3xl hero-animate-pulse-slow" style={{ animationDelay: '2s' }}></div>
        ...
        {/* Hero Content */}
        <div className="max-w-6xl mx-auto space-y-5 sm:space-y-6 md:space-y-8 z-10 opacity-100 translate-y-0 transition-all duration-1000">
          {/* Premium Badge with Animation */}
          <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-white/10 to-white/5 backdrop-blur-md border border-white/20 rounded-full text-sm font-medium shadow-lg shadow-teal-500/10 hover:shadow-teal-500/20 transition-all duration-300 hover:scale-105 cursor-default hero-animate-bounce-subtle">
            <Sparkles className="w-4 h-4 text-teal-400 hero-animate-spin-slow" />
          ...
          {hero.title && (
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black leading-[1.1] tracking-tight opacity-100 translate-y-0 transition-all duration-1000 delay-100">
          ...
          {hero.subtitle && (
            <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-300 max-w-4xl mx-auto font-light leading-relaxed opacity-100 translate-y-0 transition-all duration-1000 delay-200">
          ...
          {hero.description && (
            <p className="text-base sm:text-lg md:text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed opacity-100 translate-y-0 transition-all duration-1000 delay-300">
              {hero.description}
            </p>
          )}

          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-5 mt-8 sm:mt-10 md:mt-12 opacity-100 translate-y-0 transition-all duration-1000 delay-400">
            {hero.buttonText && hero.buttonUrl && (
              <a href={hero.buttonUrl} className="group relative">
                <div className="absolute -inset-1 bg-gradient-to-r from-teal-500 to-blue-500 rounded-full blur-lg opacity-50 group-hover:opacity-100 transition duration-300 hero-animate-pulse-slow"></div>
                <Button
                  size="lg"
          ...
          <div className="flex flex-wrap justify-center items-center gap-6 sm:gap-8 md:gap-10 mt-12 sm:mt-16 md:mt-20 px-4 opacity-100 translate-y-0 transition-all duration-1000 delay-500">
