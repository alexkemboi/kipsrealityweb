      ...
      <div className="relative z-20 container mx-auto px-6 py-12 text-center">
        ...
        <div className="relative z-10 space-y-6 max-w-4xl mx-auto">
          <p className="text-lg lg:text-xl text-[#151b1f]/80 leading-relaxed mb-6">
            At <span className="text-blue-700 font-bold">RentFlow360</span>,
          ...
          <Link href="/services">
            <Button
              size="lg"
              className="font-inter text-lg px-8 py-6 bg-blue-700 hover:bg-blue-800 text-white shadow-2xl hover:shadow-blue-600/30 transition-all duration-300 group relative overflow-hidden rounded-full"
            >
