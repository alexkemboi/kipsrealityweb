...
export default function CTAForm({ cta, onSaved }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3 px-6 sm:px-0">
      ...
      <button
        type="submit"
        className="w-full bg-green-500 hover:bg-green-600 active:bg-green-700 text-white px-4 py-2 rounded-md font-medium shadow-sm hover:shadow transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-1"
      >
